...
Continue to [Connect two peers](/rust/connect-peers) if that is enough for the application.
...
:::note An AutoNAT server measures reachability. It does not provide a relay path. Configure a Circuit Relay v2 server when peers need relayed connections or relay-assisted hole punching. :::
...
The host supplies network I/O, monotonic time, and secure entropy. Continue to [Embedded devices](/rust/embedded-devices) for the complete setup.

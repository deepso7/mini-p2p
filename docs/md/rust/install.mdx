...
An AutoNAT server measures reachability. It does not provide a relay path. Configure a Circuit Relay v2 server when peers need relayed connections or relay-assisted hole punching.

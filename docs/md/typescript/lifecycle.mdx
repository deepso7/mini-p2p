...
:::warning Keep the configuration factory pure and stable. React may render a component without committing it; the hook creates the endpoint only after commit. :::
